...
describe('Day', function() {
  ...
  it('should not render a booking if it is before start of the work', function() {
    const date = moment('2017-05-31');
    const startDate = moment('2017-05-31 09:30:00');
    const endDate = moment('2017-05-31 10:00:00');
    const store = createMockStore({ booking: { bookings: [{ startDate, endDate, isBooked: true }] } });
  ...
  it('should not render a booking if it is after end of the work', function() {
    const date = moment('2017-05-31');
    const startDate = moment('2017-05-31 18:00:00');
    const endDate = moment('2017-05-31 18:30:00');
    const store = createMockStore({ booking: { bookings: [{ startDate, endDate, isBooked: true }] } });
